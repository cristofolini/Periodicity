<template>
	<div class="wrap">
		<v-select v-model="trend" :items="trends" :label="$t('periodic_trend')" class="select" @change="renderChart(true)" dark :color="selectColor[trend]" :hint="units[trend]" persistent-hint transition="scale-transition" origin="top right"></v-select>
